...
void displayMemory() const {
    ...
    std::cout << "PHYSICAL MEMORY : " << std::fixed << std::setprecision(18) << physicalMemoryGB << " GB" << std::endl;
    //std::cout << "VIRTUAL MEMORY  : " << std::fixed << std::setprecision(10) << virtualMemoryGB << " GB" << std::endl;
